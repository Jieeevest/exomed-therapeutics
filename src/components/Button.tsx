...
const variants = {
  primary:     'bg-gold-gradient text-black hover:opacity-90 shadow-[0_0_20px_rgba(212,166,58,0.2)]',
  secondary:   'bg-white/[0.07] border border-white/[0.15] text-white hover:bg-white/[0.12]',
